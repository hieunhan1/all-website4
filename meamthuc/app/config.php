<?php
define('CONS_BASE_URL', 'http://localhost/all_v4/meamthuc');/*domain*/
define('CONS_BASE_DIR', '/all_v4/meamthuc');/*upload host tắt CONS này*/

define('CONS_HOST',		'localhost');
define('CONS_USER_DB',	'root');
define('CONS_PASS_DB',	'root');
define('CONS_DB_NAME',	'meamthuc');
...
define('CONS_IMAGES_CHEFS','public/images/daubep/');
define('CONS_IMAGES_CHEFS_THUMBS','public/_thumbs/Images/daubep/');
define('CONS_IMAGES_MONAN','public/images/monan/');
define('CONS_IMAGES_MONAN_THUMBS','public/_thumbs/Images/monan/');
