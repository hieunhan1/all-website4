...
<table width="100%" border="0" cellpadding="0" cellspacing="10" style="margin-bottom:50px">';	
	...
	$other .= '<p class="notes">Upload hình ảnh vào thư mục "<strong>daubep</strong>"</p>';
	if($row_detail['url_img'] != '') $other .= '<div class="avarta"><img src="'.CONS_IMAGES_CHEFS_THUMBS.$row_detail['url_img'].'" /></div>';
	...
	//working
	$values = $row_detail['working'];
	$properties = array('250'); //maxlength OTHER (disabled, readonly) 
	$views = array('Công việc','working','input_medium'); //label id&name class style
    $this->getProperties('1',$values,$properties,$views);
	echo $this->DisplayProperties();
	...
	$views = array('Code video','code_video','input_medium'); //label id&name class style
    $this->getProperties('1',$values,$properties,$views);
	echo $this->DisplayProperties();
