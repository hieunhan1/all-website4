<?php
define('CONS_BASE_URL', 'http://localhost/all_v4/sachhuongnghiep');/*domain*/
define('CONS_BASE_DIR', '/all_v4/sachhuongnghiep');/*upload host tắt CONS này*/

define('CONS_HOST',		'localhost');
define('CONS_USER_DB',	'root');
define('CONS_PASS_DB',	'root');
define('CONS_DB_NAME',	'sachhuongnghiep');
...
define('CONS_IMAGES_PRODUCTS','public/images/books/');
define('CONS_IMAGES_PRODUCTS_THUMBS','public/_thumbs/Images/books/');
