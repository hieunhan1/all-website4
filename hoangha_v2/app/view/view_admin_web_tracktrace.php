...
<div id="content">
	<table width="100%" border="0" cellpadding="0" cellspacing="0" id="view_select">
    	<tr bgcolor="#88C4FF">
            ...
            <th width="250" align="left">Mã</th>
            <th width="250" align="left">Đầu số mã bill</th>
            <th width="90">Thao tác</th>
        </tr>
        <?php
		$i = 0;
		$data = $this->select_from_all($lang,$arr,',`code`,`code_bill`');
		if($data){
		foreach($data as $row){
			$i++; ?>
        <tr class="row row_<?php echo $row['id'];?>">
            ...
            <td><p class="height_25px_hidden"><?php echo $row['code_bill'];?></p></td>
            <td align="center">
