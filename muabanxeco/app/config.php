<?php
define('CONS_BASE_URL', 'http://localhost/all_v4/muabanxeco');/*domain*/
define('CONS_BASE_DIR', '/all_v4/muabanxeco');/*upload host tắt CONS này*/
...
define('CONS_IMAGES_PRODUCTS_IMG','public/images/products_img/');
define('CONS_IMAGES_PRODUCTS_IMG_THUMBS','public/_thumbs/Images/products_img/');
