<?php
define('CONS_BASE_URL', 'http://localhost/all_v4/thoitrangthailan');/*domain*/
define('CONS_BASE_DIR', '/all_v4/thoitrangthailan/');/*upload host tắt CONS này*/
define('CONS_HOST', 'localhost');
define('CONS_USER_DB', 'root');
define('CONS_PASS_DB', '');
define('CONS_NAME_DB', 'thoitrangthailan');
...
/*WEBSITE*/
define('CONS_IMAGE_DEFAULT','themes/website/img/no-image.png');
