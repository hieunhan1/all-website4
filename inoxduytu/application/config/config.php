<?php
define('CONS_BASE_URL', 'http://localhost/all_v4/inoxduytu');/*domain*/
define('CONS_BASE_DIR', '/all_v4/inoxduytu/');/*upload host tắt CONS này*/
define('CONS_HOST', 'localhost');
define('CONS_USER_DB', 'root');
define('CONS_PASS_DB', '');
define('CONS_NAME_DB', 'inoxduytu');
