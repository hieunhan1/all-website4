...
<!--Insert CSS-->
<link rel="stylesheet" type="text/css" href="themes/website/styleMobile.css" media="screen and (min-width:210px) and (max-width:320px)" />
<link rel="stylesheet" type="text/css" href="themes/website/styleMobile2.css" media="screen and (min-width:320px) and (max-width:480px)" />
...
<link rel="stylesheet" type="text/css" href="themes/website/styleTablet2.css" media="screen and (min-width:768px) and (max-width:1024px)" />
