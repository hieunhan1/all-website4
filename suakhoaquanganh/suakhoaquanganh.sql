...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 02, 2015 at 11:39 AM
...
(9, 'Copyright', 'copyright', 'Copyright © 2015 by SUAKHOAQUANGANH.COM', 6, 'vi', 1),
(10, 'Email', 'email', 'info@suakhoaquanganh.com', 5, 'vi', 1),
...
(27, 'Tên trang website', 'sitename', 'Dịch vụ sửa khóa tại nhà Quang Anh', 1, 'vi', 1),
...
(6, 'Dịch vụ sửa khóa', 'dich-vu-sua-khoa', 'dich-vu-sua-khoa/', '', 'Dịch vụ sửa khóa tại nhà Quang Anh', 'Dịch vụ sửa khóa tại nhà Quang Anh trong TpHCM', 'dịch vụ sửa khóa,dich vu sua khoa,sửa khóa tại nhà,sua khoa tai nha', 0, 3, 1, 'vi', 1, 2, ',2,'),
(7, 'Thông tin dịch vụ', 'thong-tin-dich-vu', 'thong-tin-dich-vu/', '', 'Thông tin dịch vụ', 'Thông tin dịch vụ', 'thông tin dịch vụ,thong tin dich vu', 0, 4, 1, 'vi', 1, 2, ',2,'),
...
(21, 'Dịch vụ sửa khóa-Khóa xe', '', '', '', 'Dịch vụ sửa khóa xe', 'Chuyên sửa các loại khóa tại nhà. Chu đáo nhiệt tình, giá cả phải chăng. Xử lý các hư hỏng về khóa cửa, khóa phòng, khóa cổng, khóa bàn, khóa két sắt.', 'dịch vụ sửa khóa khóa xe,dich vu sua khoa khoa xe', 1, 3, 0, 'vi', 1, 14, ',9,'),
(41, 'Sửa khóa két sắt', 'sua-khoa-ket-sat', 'sua-khoa-ket-sat/', '', 'Dịch vụ sửa khóa két sắt', 'Dịch vụ sửa khóa két sắt', 'sửa khóa két sắt,sua khoa ket sat', 6, 2, 0, 'vi', 1, 2, ',2,'),
(17, 'Dịch vụ sửa khóa-Tại nhà', '', '', '', 'Dịch vụ sửa khóa tại nhà', 'Chuyên sửa các loại khóa tại nhà. Chu đáo nhiệt tình, giá cả phải chăng. Xử lý các hư hỏng về khóa cửa, khóa phòng, khóa cổng, khóa bàn, khóa két sắt.', 'dịch vụ sửa khóa tại nhà,dich vu sua khoa tai nha', 1, 1, 0, 'vi', 1, 8, ',9,'),
(42, 'Sửa khóa xe máy, xe hơi', 'sua-khoa-xe-may-xe-hoi', 'sua-khoa-xe-may-xe-hoi/', '', 'Dịch vụ sửa khóa xe máy, xe hơi', 'Dịch vụ sửa khóa xe máy, xe hơi', 'sửa khóa xe máy xe hơi,sua khoa xe may xe hoi', 6, 3, 0, 'vi', 1, 2, ',2,'),
(18, 'Dịch vụ sửa khóa-Két sắt', '', '', '', 'Dịch vụ sửa khóa két sắt', 'Chuyên sửa các loại khóa tại nhà. Chu đáo nhiệt tình, giá cả phải chăng. Xử lý các hư hỏng về khóa cửa, khóa phòng, khóa cổng, khóa bàn, khóa két sắt.', 'dịch vụ sửa khóa két sắt,dich vu sua khoa ket sat', 1, 2, 0, 'vi', 1, 14, ',9,'),
(1, 'Trang chủ', 'trang-chu', 'http://localhost/all/suakhoaquanganh', '', 'Quang Anh - Sửa khóa tại nhà, làm chìa khóa, sửa khóa xe máy xe hơi, sửa khóa két sắt', 'Sửa khóa Quang Anh chuyên sửa khóa tại nhà, làm chìa khóa, sửa khóa xe máy xe hơi, sửa khóa két sắt', 'sửa khóa tại nhà,sửa khóa xe hơi,xe máy,sửa khóa két sắt,làm chìa khóa,sua khoa', 0, 1, 0, 'vi', 1, 1, ',2,3,'),
(22, 'Làm chìa khóa-Bằng máy', '', 'javascript:;', '', 'Làm chìa khóa bằng máy', 'Chuyên sửa các loại khóa tại nhà. Chu đáo nhiệt tình, giá cả phải chăng. Xử lý các hư hỏng về khóa cửa, khóa phòng, khóa cổng, khóa bàn, khóa két sắt.', 'làm chìa khóa bằng máy,lam chia khoa bang may', 1, 4, 0, 'vi', 1, 14, ',9,'),
(40, 'Sửa khóa tại nhà', 'sua-khoa-tai-nha', 'sua-khoa-tai-nha/', '', 'Dịch vụ sửa khóa tại nhà', 'Dịch vụ sửa khóa tại nhà', 'sửa khóa tại nhà,sua khoa tai nha', 6, 1, 0, 'vi', 1, 2, ',2,'),
(39, 'Làm chìa khóa bằng máy', 'lam-chia-khoa-bang-may', 'lam-chia-khoa-bang-may/', '', 'Làm chìa khóa bằng máy', 'Làm chìa khóa bằng máy', 'làm chìa khóa bằng máy,lam chia khoa bang may', 6, 4, 0, 'vi', 1, 2, ',2,'),
...
(36, 'Bài viết mới', 'bai-viet-moi', 'bai-viet-moi/', '', 'Bài viết mới', 'Bài viết mới', 'bài viết mới,bai viet moi', 0, 0, 0, 'vi', 1, 2, ',4,'),
