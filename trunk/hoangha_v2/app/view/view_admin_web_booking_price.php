...
<div id="content">
	<table width="100%" border="0" cellpadding="0" cellspacing="0" id="view_select">
    	<tr bgcolor="#88C4FF">
            ...
            <th width="280" align="left">Weight</th>
            <th width="280" align="left">Rate</th>
            <th width="90">Thao tác</th>
        </tr>
        <?php
		$i = 0;
		$data = $this->select_from_all($lang,$arr,',`weight`,`rate`');
		if($data){
		foreach($data as $row){
			$i++; ?>
        <tr class="row row_<?php echo $row['id'];?>">
            ...
            <td><p class="height_25px_hidden"><?php echo $row['weight'];?></p></td>
            <td><p class="height_25px_hidden"><?php echo $row['rate'];?></p></td>
            <td align="center">
