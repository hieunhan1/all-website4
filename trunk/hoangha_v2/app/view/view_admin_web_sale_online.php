...
<div id="content">
	<table width="100%" border="0" cellpadding="0" cellspacing="0" id="view_select">
        ...
        <?php
		$i = 0;
		$data = $this->select_from_all($lang,$arr,',`regency`,`yahoo`,`skype`,`phone`');
		if($data){
		foreach($data as $row){
			$i++; ?>
        <tr class="row row_<?php echo $row['id'];?>">
            ...
            <td><p class="height_25px_hidden"><?php echo $row['regency'];?></p></td>
            <td><p class="height_25px_hidden"><?php echo $row['yahoo'];?></p></td>
            <td><p class="height_25px_hidden"><?php echo $row['skype'];?></p></td>
