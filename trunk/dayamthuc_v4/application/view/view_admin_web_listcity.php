<?php include_once('../../app/view/view/view_admin_search.php');?>
...
<div id="content">
	<table width="100%" border="0" cellpadding="0" cellspacing="0" id="view_select">
        ...
        <tr class="row row_<?php echo $row['id'];?>">
            ...
            <td><p class="height_row_hidden"><?php echo number_format($row['deliverycosts']);?></p></td>
            ...
            <td align="center">
                ...
                <a href="<?php echo CONS_DEFAULT_ADMIN_CONTROLLER.'file:///D|/xampp/htdocs/'.$table.'/?id='.$row['id'];?>"><img src="<?php echo CONS_ADMIN_CSS_IMG;?>edit.gif" alt=""></a> &nbsp;
