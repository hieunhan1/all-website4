...
--
-- Host: 127.0.0.1
-- Generation Time: May 31, 2015 at 07:21 AM
...
(2, 'Slogan', 'slogan', 'En Thời trang cho mọi người', 'en', 1),
...
(6, 'Phân tích thị trường', 'phan-tich-thi-truong', 'phan-tich-thi-truong/', '', 'Phân tích thị trường', 'Phân tích thị trường', 'phân tích thị trường,phan tich thi truong', 8, 4, 1, 'vi', 1, 2, ',2,3,'),
(7, 'Chương trình', 'chuong-trinh', 'chuong-trinh/', '', 'Chương trình', 'Chương trình', 'chương trình,chuong trinh', 8, 3, 1, 'vi', 1, 2, ',2,3,'),
...
(12, 'Products', 'products', 'products/', '', 'Products', 'Products', 'Products', 0, 3, 0, 'en', 1, 3, ''),
...
(21, 'Giá trị bằng cấp', 'gia-tri-bang-cap', 'gia-tri-bang-cap/', 'homeType3.jpg', 'Giá trị bằng cấp', 'Hỗ trợ học viên, những điều cần biết khi học tại trường NETSPACE: điều kiện học, hồ sơ, bằng tốt nghiệp', 'giá trị bằng cấp,gia tri bang cap', 1, 3, 0, 'vi', 1, 14, ',9,'),
(16, 'Đặt hàng', 'dat-hang', 'dat-hang/', '', 'Đặt hàng', 'Đặt hàng', 'đặt hàng,dat hang', 0, 100, 0, 'vi', 1, 8, ',1,'),
(17, 'Đội ngũ giảng viên', 'doi-ngu-giang-vien', 'doi-ngu-giang-vien/', 'homeType1.jpg', 'Đội ngũ giảng viên', 'Dịch vụ tư vấn ý tưởng, quản lý, điều hành, tái cấu trúc các mô hình, nhà hàng, tư vấn an toàn vệ sinh thực phẩm, chuỗi quán', 'đội ngũ giảng viên,doi ngu giang vien', 1, 1, 0, 'vi', 1, 8, ',9,'),
(18, 'Cơ sở vật chất', 'co-so-vat-chat', 'co-so-vat-chat/', 'homeType2.jpg', 'Cơ sở vật chất', 'Trường NETSPACE cung ứng và tuyển dụng nhân sự Đầu Bếp - Pha Chế cấp cao trong lĩnh vực nhà hàng, chuỗi quán ăn, ', 'cơ sở vật chất,co so vat chat', 1, 2, 0, 'vi', 1, 14, ',9,'),
(1, 'Trang chủ', 'trang-chu', 'http://localhost/all/dayamthuc_v4', '', 'Forexcareer', 'Des Forexcareer', 'trang chủ,trang chu', 0, 1, 0, 'vi', 1, 1, ',2,3,'),
(22, 'Cảm nghĩ học viên', 'cam-nghi-hoc-vien', 'cam-nghi-hoc-vien/', 'cam-nghi.png', 'Cảm nghĩ học viên', 'Cảm nghĩ học viên', 'cảm nghĩ học viên,cam nghi hoc vien', 1, 4, 0, 'vi', 1, 14, ',9,'),
(23, 'Mô hình học viên', 'mo-hinh-hoc-vien', 'mo-hinh-hoc-vien/', 'mo-hinh.png', 'Mô hình học viên', 'Mô hình học viên', 'mô hình học viên,mo hinh hoc vien', 1, 5, 0, 'vi', 1, 14, ',9,'),
(24, 'Khóa học mới', 'khoa-hoc-moi', 'khoa-hoc-moi/', 'khoa-hoc-moi.png', 'Khóa học mới', 'Khóa học mới', 'khóa học mới,khoa hoc moi', 1, 6, 0, 'vi', 1, 14, ',9,'),
(25, 'Chương trình đào tạo', 'chuong-trinh-dao-tao', 'chuong-trinh-dao-tao/', NULL, 'Chương trình đào tạo', 'Chương trình đào tạo', 'chương trình đào tạo,chuong trinh dao tao', 1, 7, 0, 'vi', 1, 14, ',9,'),
(26, 'Tin tức - Sự kiện', 'tin-tuc-su-kien', 'tin-tuc-su-kien/', NULL, 'Tin tức - Sự kiện', 'Tin tức - Sự kiện', 'tin tức sự kiện,tin tuc su kien', 1, 8, 0, 'vi', 1, 14, ',9,'),
(27, 'Hình ảnh', 'hinh-anh', 'hinh-anh/', '', 'Hình ảnh', 'Hình ảnh', 'hình ảnh,hinh anh', 1, 9, 0, 'vi', 1, 5, ',9,');
...
(21, 'Liên hệ trực tuyến', 'web_contact', 'icon-lien-he.jpg', 90, 0, '<span id="web_contact" class="ajax_thongtin"></span>', 1),
...
(11, 'menu', 'Danh mục menu', 'web_menu', 'public/images/catalog/', 'public/_thumbs/Images/catalog/', 'vi', 11, 1, 1),
(12, 'slider_banner', 'Slider - Banner', 'web_slider_banner', 'public/images/slider-banner/', 'public/_thumbs/Images/slider-banner/', 'vi', 12, 1, 1),
...
(2, 'Hội đầu bếp', 'hoidaubep.png', 'javascript:;', 1, 'vi', 1, 3, ','),
(4, 'Evolution', 'evolution.png', 'javascript:;', 2, 'vi', 1, 3, ''),
(5, 'Daruma', 'daruma.png', 'javascript:;', 3, 'vi', 1, 3, ''),
(6, 'Asima', 'asima.png', 'javascript:;', 4, 'vi', 1, 3, ''),
(7, 'Ba con cừu', 'baconcuu.png', 'javascript:;', 5, 'vi', 1, 3, ''),
(8, 'Event', 'event.jpg', 'javascript:;', 0, 'vi', 1, 2, ',26,');
...
(25, 'Admin', '123 CMT 8', '0988 388 003', 'hieunhan1121@gmail.com', 0, 1, '', '', 'admin', 'fc7fc678608590b123692867f176fe63', ',1,2,3,4,5,6,7,8,13,14,20,15,16,17,21,22,23,', ',1,2,3,4,5,6,7,8,13,14,20,15,16,17,21,22,23,', NULL, 0, 'vi', 0, 1, 3),
