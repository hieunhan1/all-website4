...
<div class="viewpost">
    ...
    <div style="width:340px; float:right">
    	<div class="viewpost">
			...
			if($row['status']==3){
				$title = 'Máy công nghiệp BY';
				$subject = 'No-reply | Mã số đơn hàng Maycongnghiepby.com: '.$row['id'];
				$body = '<div style="width:770px; line-height:140%; color:#333; font-size:13px; font-family:Arial, Helvetica, sans-serif; margin:20px auto">
					...
					<div style="width:770px; padding:5px; border:solid 5px #3C9401">
						...
						<p>Cám ơn Quý khách đã đặt hàng tại Maycongnghiepby.com</p>
						...
						<table width="100%" border="0" cellpadding="5" cellspacing="0" style="line-height:140%; color:#333; font-size:13px; font-family:Arial, Helvetica, sans-serif">
							...
							<tr>
								...
								<td>Giao hàng tận nơi trong nội thành (Tp.HCM)</td>
							</tr>	
						</table>
						...
						<span style="font-weight:bold; color:#307601">Maycongnghiepby.com - Máy công nghiệp BY</span></p>
				...
				$add_bcc = array();
				//$add_bcc[] = array('email'=>$this->_config['email'],'name'=>'BY');
