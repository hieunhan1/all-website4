...
foreach($data as $row){
	echo '<tr bgcolor="#FFFFDD">
		...
		<td align="right" style="border-bottom:solid 1px #CCC">'.number_format($row['dongia'],0,',','.').'đ</td>
...
echo '<tr bgcolor="#FFFF99">
		<th align="right" style="border-bottom:solid 1px #CCC" colspan="2"><span style="padding-right:50px">Tổng cộng:</span><em>(phí giao hàng: '.number_format($row_detail['phigiaohang'],0,',','.').'đ)</em></th>
