...
<table width="100%" border="0" cellpadding="0" cellspacing="10" style="margin-bottom:50px">';	
	...
	$other .= '<p class="notes">Upload hình ảnh vào thư mục "<strong>chefs</strong>"</p>';
	if($row_detail['url_img'] != '') $other .= '<div class="avarta"><img src="'.CONS_IMAGES_MONAN_THUMBS.$row_detail['url_img'].'" /></div>';
	...
	//daubep_id
	$values = $row_detail['daubep_id'];
	$properties = array('100'); //maxlength OTHER (disabled, readonly) 
	$views = array('Đầu bếp','daubep_id','input_medium'); //label id&name class style
    $this->getProperties('1',$values,$properties,$views);
	echo $this->DisplayProperties();
