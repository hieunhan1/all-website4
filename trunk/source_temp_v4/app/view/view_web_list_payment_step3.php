...
<div class="viewpost">
    ...
    <div style="width:600px; float:left">
        ...
        <p style="font-weight:bold">Bạn sẽ thanh toán bằng tiền mặt khi nhận hàng tại nhà.</p>
        <p style="font-weight:bold">Chúng tôi sẽ liên hệ với bạn trước khi giao hàng.</p>
    	<p style="color:#F00">Phí giao hàng: <b>0 VNĐ</b></p>
        <div style="color:#666; margin:30px 0 0 35px">
