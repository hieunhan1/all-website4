...
<div id="content">
	<table width="100%" border="0" cellpadding="0" cellspacing="0" id="view_select">
    	<tr bgcolor="#88C4FF">
            ...
            <th width="90">Support S1</th>
            <th width="90">Support S2</th>
            <th width="90">Support R3</th>
            <th width="95">Resistance R1</th>
            <th width="95">Resistance R2</th>
            <th width="95">Resistance R3</th>
            <th width="110">Ngày</th>
            <th width="110">Thao tác</th>
        </tr>
        <?php
		$i = 0;
		$data = $this->select_from_all($lang,$arr,',`support_s1`,`support_s2`,`support_r3`,`resistance_r1`,`resistance_r2`,`resistance_r3`,`datetime`');
		if($data){
		foreach($data as $row){
			$i++; ?>
