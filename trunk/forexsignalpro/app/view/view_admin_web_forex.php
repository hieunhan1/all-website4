...
<div id="content">
	<table width="100%" border="0" cellpadding="0" cellspacing="0" id="view_select">
    	<tr bgcolor="#88C4FF">
            ...
            <th width="160">Chính xác</th>
            <th width="150" align="left">Ngày</th>
            <th width="90">Thao tác</th>
        </tr>
        <?php
		$i = 0;
		$data = $this->select_from_all($lang,$arr,',`exactly`,`datetime`');
		if($data){
		foreach($data as $row){
			$i++; ?>
        <tr class="row row_<?php echo $row['id'];?>">
            ...
            <td align="center">
				<?php
                if($row['exactly']==1) echo '<span class="true">True</span>';
                elseif($row['exactly']==0) echo '<span class="false">False</span>';
                else echo '<span style="color:#00F">chưa biết</span>';
                ?>
            </td>
