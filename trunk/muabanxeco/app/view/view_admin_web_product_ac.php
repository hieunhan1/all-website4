...
<table width="100%" border="0" cellpadding="0" cellspacing="10" style="margin-bottom:50px">';	
	...
	$other .= '<p class="notes">Upload hình ảnh vào thư mục "<strong>product</strong>"</p>';
	if($row_detail['img_avatar'] != '') $other .= '<div class="avarta"><img src="'.CONS_IMAGES_PRODUCTS_THUMBS.$row_detail['img_avatar'].'" /></div>';
	...
	$properties = ''; //disabled, readonly
	$views = array('Đặc tính','dactinh','textarea'); //label id&name class colspan
	$other = $this->ckeditor_custom('dactinh');
