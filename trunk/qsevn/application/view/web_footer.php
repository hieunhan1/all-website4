	...
	<div class="content">
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
        	<tr>
            	<td>
                	<div class="info">
                        <h2><?php echo $config['copyright']; echo $config['sitename'];?></h2>
                        <p><?php echo CONS_CONTACT_ADDRESS.': '.$config['address'];?></p>
                        <p><?php echo CONS_CONTACT_PHONE.': '.$config['tel'];?> &nbsp; - &nbsp; Email: <a href="mailto:<?php echo $config['email'];?>"><?php echo $config['email'];?></a></p>
                    </div>
                </td>
                <td>
                	<div id="social">
