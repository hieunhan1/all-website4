...
<div id="slider" class="content">
	<div class="slider-wrapper theme-default"><div id="slider_run" class="nivoSlider">
		<?php
        foreach($data as $row){
            echo '<a href="'.$row['url'].'"><img src="'.$urlImg[12]['url_img'].$row['img'].'" data-thumb="'.$urlImg[12]['url_img_thumb'].$row['img'].'" alt="'.$row['name'].'" title="'.$row['info'].'" data-transition="slideInLeft" /></a>';
        }
        ?>
    </div></div>
</div>
