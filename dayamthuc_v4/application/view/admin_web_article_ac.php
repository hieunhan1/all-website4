...
<table width="100%" border="0" cellpadding="0" cellspacing="10" style="margin-bottom:50px">';	
	...
	$data = $cF->inputRadio($name, $values, $valueCheck, 'radio');
	$data .= '<span style="font-style:italic; padding-top:10px">id="ghidanh" sẽ link đến form Đăng Ký</span>';
	echo $cF->displayTable('Hiện form đăng ký,<br />lịch khai giảng', $data);
