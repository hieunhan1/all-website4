<div id="right">
    ...
    <div class="viewpost">
        ...
        <h2 style="margin-bottom:20px"><?php echo $currentMenu['description'];?></h2>
    </div>
...
<div id="left">
	<div id="other_about">
    <?php
	$data = $this->_model->_list_menu_parent($currentMenu['rootId']);
	if(count($data) > 0){
		foreach($data as $row){
	...
	<?php include_once('../../app/view/view_web_quick_booking.php');?>
</div>
