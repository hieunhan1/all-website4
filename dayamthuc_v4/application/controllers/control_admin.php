...
class control_admin extends control_admin_form{
	...
	public function index(){
		include_once('../../app/controller/error/error_admin.php');
	...
	public function frm_login(){
		...
		include_once('../../app/controller/view/view_admin_login.php');
	}
	...
	public function administrator(){
		...
		if(isset($_GET['ajax'])){
			include_once('../../app/controller/view/view_admin_ajax.php');
			return TRUE;
		}/*ajax*/
		...
		if($_GET['user']==CONS_ADMIN_LOGOUT){
			...
			$include = ob_start();
			include_once('../../app/controller/view/view_admin_account.php');
			$include = ob_get_clean();
		...
		include_once('../../app/controller/view/view_admin.php'); /*view*/
	}
