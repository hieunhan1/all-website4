...
class controlAdminForm{
	...
	public function ckeditorFull($name, $dir='js/'){
		...
		CKEDITOR.replace( '{$name}', {
			uiColor: '#b5d8ef',
			filebrowserBrowseUrl: 		'".$dir."ckeditor/ckfinder/ckfinder.php',
			filebrowserImageBrowseUrl: 	'".$dir."ckeditor/ckfinder/ckfinder.php?Type=Images',
			filebrowserFlashBrowseUrl: 	'".$dir."ckeditor/ckfinder/ckfinder.php?Type=Flash',
