...
$(document).ready(function(e) {
	...
	/*changeAlias*/
	$("#changeAlias").live("click", function(){
	...
	$(".auto_link_detail").live("dblclick", function(){
	...
	function checks_box_item(list_check, list_view){
		$(list_check).live("change", function(){
			var str=",";
	...
	checks_box_item('.checkboxItemTab', '.valueChecksBoxTab');
